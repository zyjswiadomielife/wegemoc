# Generated by Django 2.2.13 on 2020-08-11 09:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_pl', models.CharField(db_index=True, max_length=63, verbose_name='Title')),
                ('title_en', models.CharField(blank=True, db_index=True, max_length=63, verbose_name='Title')),
                ('summary_pl', models.TextField(verbose_name='Summary')),
                ('summary_en', models.TextField(blank=True, verbose_name='Summary')),
                ('content_pl', models.TextField(verbose_name='Terms and Conditions')),
